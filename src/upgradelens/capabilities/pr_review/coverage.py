"""PR review coverage (plan stage S4).

A small deterministic coverage measure: what fraction of the changed, non-deleted
files are cited by at least one finding. This mirrors the S4 coverage gate and is
...
__all__ = ["compute_pr_review_coverage", "CoverageSummary"]
